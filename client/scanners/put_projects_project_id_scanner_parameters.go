...
func (o *PutProjectsProjectIDScannerParams) WithPayload(payload *models.ProjectScanner) *PutProjectsProjectIDScannerParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the put projects project ID scanner params
func (o *PutProjectsProjectIDScannerParams) SetPayload(payload *models.ProjectScanner) {
	o.Payload = payload
}
