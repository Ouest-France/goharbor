...
func (o *PutProjectsProjectIDParams) WithProject(project *models.ProjectReq) *PutProjectsProjectIDParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the put projects project ID params
func (o *PutProjectsProjectIDParams) SetProject(project *models.ProjectReq) {
	o.Project = project
}
