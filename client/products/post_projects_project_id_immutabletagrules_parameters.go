...
func NewPostProjectsProjectIDImmutabletagrulesParams() *PostProjectsProjectIDImmutabletagrulesParams {
	var ()
	return &PostProjectsProjectIDImmutabletagrulesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostProjectsProjectIDImmutabletagrulesParamsWithTimeout creates a new PostProjectsProjectIDImmutabletagrulesParams object
...
// NewPostProjectsProjectIDImmutabletagrulesParamsWithContext creates a new PostProjectsProjectIDImmutabletagrulesParams object
...
// NewPostProjectsProjectIDImmutabletagrulesParamsWithHTTPClient creates a new PostProjectsProjectIDImmutabletagrulesParams object
...
for the post projects project ID immutabletagrules operation typically these are written to a http.Request
*/
type PostProjectsProjectIDImmutabletagrulesParams struct {

	/*Immutabletagrule*/
	Immutabletagrule *models.ImmutableTagRule
	/*ProjectID
	  Relevant project ID.
...
func (o *PostProjectsProjectIDImmutabletagrulesParams) WithImmutabletagrule(immutabletagrule *models.ImmutableTagRule) *PostProjectsProjectIDImmutabletagrulesParams {
...
func (o *PostProjectsProjectIDImmutabletagrulesParams) SetImmutabletagrule(immutabletagrule *models.ImmutableTagRule) {
