...
type PutUsersUserIDSysadminParams struct {
	...
	*/
	HasAdminRole *models.HasAdminRole
	/*UserID
	  Registered user ID
...
// WithHasAdminRole adds the hasAdminRole to the put users user ID sysadmin params
func (o *PutUsersUserIDSysadminParams) WithHasAdminRole(hasAdminRole *models.HasAdminRole) *PutUsersUserIDSysadminParams {
	o.SetHasAdminRole(hasAdminRole)
	return o
}

// SetHasAdminRole adds the hasAdminRole to the put users user ID sysadmin params
func (o *PutUsersUserIDSysadminParams) SetHasAdminRole(hasAdminRole *models.HasAdminRole) {
	o.HasAdminRole = hasAdminRole
}
...
func (o *PutUsersUserIDSysadminParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.HasAdminRole != nil {
		if err := r.SetBodyParam(o.HasAdminRole); err != nil {
			return err
		}
	}
